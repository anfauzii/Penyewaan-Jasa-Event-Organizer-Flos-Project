...
namespace FlosProjects
{
    public partial class DataDetailPesanan : Form
    {
        ...
        void Search()
        {
            ...
            {
                Koneksi.conn.Open();
                MySqlDataAdapter Tampil = new MySqlDataAdapter("SELECT  * FROM detail_pesanan where kuantitas like '%" + txtSearch.Text + "%' or id_barang like '%" + txtSearch.Text + "%' or id_pesanan like '%" + txtSearch.Text + "%'", Koneksi.conn);
                DataTable data = new DataTable();
                Tampil.SelectCommand.ExecuteNonQuery();
                Tampil.Fill(data);
                dgvDetailPesanan.DataSource = data;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd = new MySqlCommand("delete from detail_pesanan where id_pesanan='" + cbPesanan.Text + "'", Koneksi.conn);
                    Koneksi.conn.Open();
                    cmd.ExecuteNonQuery();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    cmd = new MySqlCommand("update detail_pesanan set kuantitas='" + txtKuantitas.Text + "' where id_pesanan='" + cbPesanan.Text + "'", Koneksi.conn);
                    Koneksi.conn.Open();
                    cmd.ExecuteNonQuery();
        ...
        private void cbPesanan_SelectedIndexChanged(object sender, EventArgs e)
        {
