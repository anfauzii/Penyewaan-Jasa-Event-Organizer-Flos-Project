    ...
    public partial class DataJenisPembayaran : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    cmd = new MySqlCommand("update jenis_pembayaran set nama_pembayaran='" + txtNama.Text + "', nama_Akun='" + txtNamaAkun.Text + "', no_Akun='" + txtNoAkun.Text + "' where id_pembayaran='" + txtIdJenis.Text + "'", Koneksi.conn);
                    Koneksi.conn.Open();
                    cmd.ExecuteNonQuery();
        ...
        private void txtIdJenis_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtNoAkun_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtNamaAkun_TextChanged(object sender, EventArgs e)
        {
